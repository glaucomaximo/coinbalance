"""
Evento de domínio: StakeIncreased
"""
...
class StakeIncreased(DomainEvent):
    """
    Evento disparado quando o stake de um validador é aumentado.
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "increase_cnb": float(self.new_amount.to_cnb() - self.old_amount.to_cnb()),
